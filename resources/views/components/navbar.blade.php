            ...
            <div class="hidden md:block">
              ...
              -->
                        <div
                            ...
                            <a href="/profile" :active="request()->is('profile')" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
                            <a href="/setting" :active="request()->is('setting')" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Settings</a>
